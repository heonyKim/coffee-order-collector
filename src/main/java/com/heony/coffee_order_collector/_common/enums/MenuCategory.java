...
public enum MenuCategory {
    ...
    MAMMOTH_COFFEE("커피", new StoreType[]{StoreType.MAMMOTH_COFFEE, StoreType.MAMMOTH_COFFEE_NEW, StoreType.MAMMOTH_EXPRESS}),
    MAMMOTH_COLD_BREW("콜드브루", new StoreType[]{StoreType.MAMMOTH_COFFEE, StoreType.MAMMOTH_COFFEE_NEW, StoreType.MAMMOTH_EXPRESS}),
    MAMMOTH_NON_COFFEE("논커피", new StoreType[]{StoreType.MAMMOTH_COFFEE, StoreType.MAMMOTH_COFFEE_NEW, StoreType.MAMMOTH_EXPRESS}),
    MAMMOTH_TEA_ADE("티·에이드", new StoreType[]{StoreType.MAMMOTH_COFFEE, StoreType.MAMMOTH_COFFEE_NEW, StoreType.MAMMOTH_EXPRESS}),
    MAMMOTH_MIXED("프라페·블렌디드", new StoreType[]{StoreType.MAMMOTH_COFFEE, StoreType.MAMMOTH_COFFEE_NEW, StoreType.MAMMOTH_EXPRESS}),
